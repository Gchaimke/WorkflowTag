                ...
                <table class="table">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" class="mobile-hide">Checklist</th>
                    ...
                    <?php foreach ($notes as $note) {
                        ...
                        echo "<td>" . $clients[$note->client_id] . "</td>";
                        echo "<td>$note->project</td>";
                        echo "<td><a class='btn btn-info' href='/production/edit_checklist/$note->checklist_id'>$note->checklist_id</td>";
