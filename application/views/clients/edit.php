...
<main role="main">
	<div class="jumbotron">
		<div class="container">
			<center>
				<h2 class="display-3">Edit Client: <?php echo $client ?></h2>
			</center>
		</div>
	</div>
	<div class="container">
		<center>
			...
			<input id='client_name' type='text' class="form-control" name='name' value="<?php echo $client ?>" hidden></hr>
			<div class="form-group mb-3">
				<label>Select Logo : </label>
				<input id="logo_path" type='text' class="form-control" name='logo' value="<?php echo $logo ?>" hidden>
